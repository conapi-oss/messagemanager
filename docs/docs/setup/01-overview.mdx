...
You can download the latest version of Message Manager from the [official website](https://www.conapi.com/message-manager).
...
This version does not require a Java Runtime Environment (version 17) to be installed on your system as it comes with a bundled JRE.

:::

To install Message Manager, follow these steps:

1. Download the latest version of Message Manager MSI from the [official website](https://www.conapi.com/message-manager).
...
You need to first install a Java Runtime Environment (version 17) on your system.

:::

To install Message Manager, follow these steps:

1. Download the latest version of Message Manager zip/tar.gz from the [official website](https://www.conapi.com/message-manager).
...
In the bin folder of the installation package, there is a file named "setenv.sh.template" (Linux/MacOS) and "setenv.cmd.template" (Windows) in this folder.
