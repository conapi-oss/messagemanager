...
To work with Message Manager and Apache ActiveMQ, a connection to an ActiveMQ installation using an ActiveMQ Profile is required.
...
:::note
The ActiveMQ jars can be found in the ActiveMQ installation under the lib directory or downloaded separately.<br/>
Also: make sure to rename the jar files containing UNDERSCORES and replace them with DASHES.
:::
