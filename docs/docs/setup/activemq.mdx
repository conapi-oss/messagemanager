...
The required ActiveMQ jars are (version 5.19.1 recommended):
...
:::note
The ActiveMQ jars can be found in the ActiveMQ Classic 5.x installation under the lib directory or downloaded from Maven Central.<br/>
