...
1. Launch Message Manager (i.e. from the start menu or by double-clicking the icon).
...
5. Depending on the selected [profile](../features/multibroker), you can now configure the connection to the broker/messaging-system.
6. Connect to the broker/messaging-system.
7. Use Queue Browser, Topic Subscriber and Message Sender. Options may vary depending on the selected profile.
 
:::tip

For more detailed information on how to use Message Manager, please refer to the features section.