...
Out of the box, Message Manager is setup to avoiding classloading issues but if you are using other JARs, you may encounter classloading issues.
The following section describes how to fix classloading issues. If you are still having issues, please contact the support team.
...
Quick test: Remove the profile, restart Message Manager. The profile will be recreated with our latest suggestions for the classpath!
