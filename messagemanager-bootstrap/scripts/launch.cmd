...
if "%~1"=="debug" (
    call %LAUNCHER_JAVA_DEBUG% %JVM_OPTS% -Ddeveloper=true -p bootstrap\update4j.jar --add-modules jdk.attach,jdk.unsupported,java.scripting,java.net.http,java.sql,java.naming -m org.update4j/org.update4j.Bootstrap --remote %UPDATE_URL% --syncLocal --local setup.xml --launchFirst
) else if "%~1"=="rdebug" (
    ...
    start %LAUNCHER_JAVA% %JVM_OPTS% -p bootstrap\update4j.jar --add-modules jdk.attach,jdk.unsupported,java.scripting,java.net.http,java.sql,java.naming -m org.update4j/org.update4j.Bootstrap --remote %UPDATE_URL% --syncLocal --local setup.xml --launchFirst
)
