...
public enum MessageType {
	...
	XML_MESSAGE("XML-Message", nl.queuemanager.core.jms.JMSXMLMessage.class),
	BYTES_MESSAGE("Bytes-Message", javax.jms.BytesMessage.class),
	MULTIPART_MESSAGE("Multipart-Message", nl.queuemanager.core.jms.JMSMultipartMessage.class),
